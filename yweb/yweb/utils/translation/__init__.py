...
from yweb.utils.encoding import force_text
from yweb.utils.functional import lazy
...
class Trans(object):
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from yweb.utils.translation import trans_real as trans
        else:
            from yweb.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from yweb.conf.locale import LANG_INFO
    try:
